  ...
  return (
    <main>
      <div className="relative isolate">
        ...
        >
          <div
            className="aspect-[801/1036] w-[50.0625rem] bg-gradient-to-tr from-[#94d88b] to-[#9ee0bc] opacity-30"
            style={{
              clipPath:
                ...
                <div className="ml-auto w-44 flex-none space-y-8 pt-32 sm:ml-0 sm:pt-80 lg:order-last lg:pt-36 xl:order-none xl:pt-80">
                  <div className="relative">
                    <Image
                      ...
                      height={0}
                      width={0}
                      src="/lash-pics/lash-1.png"
                      alt=""
                      className="aspect-[2/3] w-full rounded-xl bg-emerald-900/5 object-cover shadow-lg"
                    />
                    <div className="pointer-events-none absolute inset-0 rounded-xl ring-1 ring-inset ring-emerald-900/10" />
                  </div>
                </div>
